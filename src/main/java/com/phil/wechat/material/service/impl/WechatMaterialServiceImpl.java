...
//            log.error(result);
    ...
    public String getTempMaterial(String accessToken, String mediaId) {
        ...
        return HttpUtil.doGet(wechatMaterialConfig.getGetTempMediaUrl(), params);
    }
    ...
    public GetMaterialResult getMaterial(String accessToken, String mediaId) {
        ...
        String result = HttpUtil.doPost(wechatMaterialConfig.getGetMaterialUrl(), params, data.toString());
    ...
    public ResultState deleteMaterial(String accessToken, String mediaId) {
        ...
        JsonObject data = new JsonObject();
        data.addProperty("media_id", mediaId);
        String result = HttpUtil.doPost(wechatMaterialConfig.getDeleteMaterialUrl(), params, data.toString());
    ...
    public MaterialCountResult geMaterialCount(String accessToken) {
        Map<String, String> params = new HashMap<>();
        params.put("access_token", accessToken);
        String result = HttpUtil.doGet(wechatMaterialConfig.getGetMaterialcountUrl(), params);
