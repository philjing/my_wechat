...
public class WechatTemplateMessageServiceImplTest {
    ...
    public void testSendTemplate() {
        ...
        params.put("keyword1", template.item("8.1发现尼泊尔—人文与自然的旅行圣地", "#000000"));
        params.put("keyword2", template.item("5000元", "#000000"));
        params.put("keyword3", template.item("2017.1.2", "#000000"));
        params.put("keyword4", template.item("5", "#000000"));
